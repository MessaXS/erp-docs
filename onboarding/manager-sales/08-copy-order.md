...
Нажмите кнопку **"Копировать заказ"** (или аналогичную кнопку в интерфейсе).
...
![Шаг 3 — Выбор диапазона дат](img/08-step-03.png)
...
*Предыдущий процесс: [Создать заявку в заказе](./07-create-request.md)*
*Следующий процесс: [Назначить исполнителей](./09-assign-workers.md)*
