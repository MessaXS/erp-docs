...
![Шаг 2 — Фильтры (период, объект)](img/10-step-02.png)
...
![Шаг 4 — Детали проблемного заказа](img/10-step-04.png)
...
*Предыдущий процесс: [Назначить исполнителей](./09-assign-workers.md)*
*Следующий процесс: [Начисления и удержания](./11-accruals-deductions.md)*
