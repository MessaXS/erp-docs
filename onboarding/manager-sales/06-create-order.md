...
### Шаг 2. Укажите дату заказа

Выберите дату, на которую клиент запросил работников.

![Шаг 2 — Поле выбора даты](img/06-step-02.png)
...
### Шаг 5. Укажите комментарий

В поле **"Комментарий"** можете добавить другую полезную информацию по заказу. 

---

### Шаг 6. Сохраните заказ

Нажмите **"Сохранить"**, либо нажмите Enter на клавиатуре.

![Шаг 5 — Созданный заказ](img/06-step-06.png)

> **Обратите внимание:** При успешном добавлении заказа вы получите соответствующее pop-up уведомление в правом верхнем углу.
